...
import { GradeApprove } from '../gradeapprove/gradeapprove';
import { GradeRequest } from '../graderequest/graderequest';
...
export class Grade {
	...
	{
		this.navCtrl.push(GradeRequest);
	}

	ApproveCertification()
	{
		this.navCtrl.push(GradeApprove);
	}
